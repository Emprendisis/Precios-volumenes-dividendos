...
if st.button("🔽 Obtener datos"):
    try:
        ...
        if data.empty:
            ...
            # Preparar precios_volumen para Excel
            ...
            # Preparar dividendos para Excel (aunque estén vacíos)
            ...
            # Mostrar mensaje si hay o no hay dividendos
